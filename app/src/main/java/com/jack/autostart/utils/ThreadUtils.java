...
public final class ThreadUtils {
    ...
    /**
     * Runs the specified runnable on the main thread after a delay.
     *
     * @param runnable    The runnable to run on the main thread.
    ...
    /**
     * Removes the specified callback from the main thread handler.
     *
    ...
    /**
     * Removes the specified callback from the main thread handler and re-posts it with the given delay.
     *
     * @param runnable    The runnable to re-post.
     * @param delayMillis The delay in milliseconds.
     */
    public static void reRunOnUiThread(Runnable runnable, long delayMillis) {
        HANDLER.removeCallbacks(runnable);
        HANDLER.postDelayed(runnable, delayMillis);
    }

    /**
     * Removes the specified callback from the main thread handler and re-posts it without a delay.
     *
     * @param runnable The runnable to re-post.
     */
    public static void reRunOnUiThread(Runnable runnable) {
        HANDLER.removeCallbacks(runnable);
        HANDLER.post(runnable);
    }

    /**
     * Checks if the main thread handler has the specified callback in its queue.
     *
     * @param runnable The runnable to check.
     * @return {@code true} if the main thread handler has the callback, {@code false} otherwise.
     */
